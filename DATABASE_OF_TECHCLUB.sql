...
--
-- Host: mysql-13453568-techclub-found-club-927f.d.aivencloud.com    Database: defaultdb
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '4667c4ba-490b-11f1-8a72-b6c4af6c0cdd:1-28,
72807085-483f-11f1-a4fb-569343e6527b:1-294';
...
CREATE TABLE `hackathon_table` (
  ...
  CONSTRAINT `fk_hack_admin` FOREIGN KEY (`admin_id`) REFERENCES `user_master` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_hack_judge` FOREIGN KEY (`judge_id`) REFERENCES `user_master` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_hack_status` FOREIGN KEY (`status_id`) REFERENCES `status_master` (`status_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `project` (
  ...
  CONSTRAINT `fk_project_team` FOREIGN KEY (`team_id`) REFERENCES `team` (`team_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `scores` (
  ...
  CONSTRAINT `fk_score_hack` FOREIGN KEY (`hackathon_id`) REFERENCES `hackathon_table` (`hackathon_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_score_judge` FOREIGN KEY (`judge_id`) REFERENCES `user_master` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_score_project` FOREIGN KEY (`team_id`, `project_title`) REFERENCES `project` (`team_id`, `project_title`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `scores` VALUES ('U-026','H-018','T-002','ShieldNet',8,7,10),('U-028','H-014','T-036','CodeCrusaders Cyber',8,7,5),('U-029','H-007','T-033','SyntaxSquad Web',6,10,9),('U-030','H-006','T-003','HealthTrack',6,7,7),('U-031','H-024','T-035','PixelPioneers AI',9,8,9),('U-032','H-016','T-001','StatGen',7,10,8),('U-032','H-016','T-009','AI Healthcare Bot',5,0,6),('U-033','H-002','T-032','CloudCommandos',5,6,7),('U-034','H-010','T-004','CryptoPay',8,10,7),('U-034','H-017','T-005','SwiftOrder',9,10,10),('U-035','H-019','T-007','SkyStorage',9,9,10),('U-039','H-008','T-021','MediChain',7,8,6),('U-039','H-008','T-023','Zenith Web',9,8,9),('U-043','H-022','T-034','DevDrafts App',9,8,8);
...
CREATE TABLE `sponsor_hackathon` (
  ...
  KEY `hackathon_id` (`hackathon_id`),
  CONSTRAINT `fk_sh_hack` FOREIGN KEY (`hackathon_id`) REFERENCES `hackathon_table` (`hackathon_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_sh_sponsor` FOREIGN KEY (`sponsor_id`) REFERENCES `sponsor_table` (`sponsor_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `sponsor_table` (
  ...
  KEY `admin_id` (`admin_id`),
  CONSTRAINT `fk_spon_admin` FOREIGN KEY (`admin_id`) REFERENCES `user_master` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
INSERT INTO `status_master` VALUES (1,'Upcoming'),(2,'Evaluated'),(3,'Upcoming'),(4,'Upcoming'),(5,'Upcoming'),(6,'Evaluated'),(7,'Evaluated'),(8,'Evaluated'),(9,'Evaluated'),(10,'Evaluated'),(11,'Evaluated'),(12,'Evaluated'),(13,'Evaluated'),(14,'Evaluated'),(15,'Evaluated'),(16,'Evaluated'),(17,'Evaluated'),(18,'Evaluated'),(19,'Evaluated'),(20,'Upcoming'),(21,'Upcoming'),(22,'Evaluated'),(23,'Upcoming'),(24,'Evaluated'),(25,'Upcoming'),(26,'Upcoming'),(27,'Upcoming');
...
CREATE TABLE `team` (
  ...
  KEY `lead_id` (`lead_id`),
  KEY `hackathon_id` (`hackathon_id`),
  CONSTRAINT `fk_team_hack` FOREIGN KEY (`hackathon_id`) REFERENCES `hackathon_table` (`hackathon_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_team_lead` FOREIGN KEY (`lead_id`) REFERENCES `user_master` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `team_members` (
  ...
  CONSTRAINT `fk_tm_member` FOREIGN KEY (`member_id`) REFERENCES `user_master` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `workshop_attendees` (
  ...
  CONSTRAINT `fk_wa_participant` FOREIGN KEY (`participant_id`) REFERENCES `user_master` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_wa_workshop` FOREIGN KEY (`workshop_id`) REFERENCES `workshop_table` (`workshop_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `workshop_table` (
  ...
  KEY `hackathon_id` (`hackathon_id`),
  CONSTRAINT `fk_work_admin` FOREIGN KEY (`admin_id`) REFERENCES `user_master` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_work_hack` FOREIGN KEY (`hackathon_id`) REFERENCES `hackathon_table` (`hackathon_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_work_mentor` FOREIGN KEY (`mentor_id`) REFERENCES `user_master` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
-- Dump completed on 2026-05-08 19:57:45
